...
export default function MyEvents() {
  ...
  const [loadingTicketGeneration, setLoadingTicketGeneration] = useState(false);
  ...
  const handleGenerateActivationTicketsToken = async (eventId: string) => {
    ...
    setLoadingTicketGeneration(true);
    try {
      ...
      setLoadingTicketGeneration(false);
    }
  };
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-8 pt-24 max-w-full overflow-x-hidden">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        >
                          {loadingTicketGeneration ? (
                            <div className="flex items-center gap-2">
                              <span className="ml-2">Gerando Token...</span>
                        ...
                        {ticketGenerated && !loadingTicketGeneration && (
        ...
        <div className="max-w-6xl mx-auto mt-12">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-4"></div>
